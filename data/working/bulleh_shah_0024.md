...
id: bulleh_shah_0024
poet_id: bulleh_shah
title: "Bharosa keh ashnaai da (Acquaintance)"
work_type: "kafi"
source_ids:
...
- Notes: Vision transcription of Rafat poem 23, read from the calligraphic Nastaliq facing page (book p.88). Only a single couplet appears on the page (as with several of the shorter selections). Transcription high-confidence; still worth verifying against a print Kulliyat.
...
_Reference translation by Taufiq Rafat, "Bulleh Shah: A Selection" (Vanguard, 1982), p.89. COPYRIGHTED — private reference only; do NOT publish or use for training._

# AI Translation

What trust is there in mere acquaintance? —
it is the indifference it may bring that I fear.
...
- URL or bibliographic reference: Vanguard Books, Lahore, 1982 — Rafat poem 23 "Acquaintance", English book p.89 / Urdu original p.88
...
- Questions: Verify the couplet against a print Kulliyat; confirm whether it is a standalone couplet or an excerpt from a longer kafi.
- Uncertainties: Low — بھروسا کیہ آشنائی دا / ڈر لگدا بے پروائی دا reads clearly.
