...
id: bulleh_shah_0047
poet_id: bulleh_shah
title: "Mullāṁ te mashālchī (The Benighted)"
work_type: "kafi"
source_ids:
...
مُلاں تے مشالچی دونہاں اِکو چِت
لوکاں کر دے چاننا، آپ انھیرے وِچ

# Script Notes

- Script: Shahmukhi (Perso-Arabic)
- Language spans: Punjabi
- Notes: Vision transcription of Rafat poem 46, read from the calligraphic Nastaliq facing page (book p.152). Single spread (Urdu book p.152 / English book p.153; PDF pages 172 / 173). This is a short two-line couplet (dohṛā); the facing page carries only these two lines, which is normal. The next spread begins a new poem ("میری بکل دے وچ چور"). Needs native/scholarly verification.
...
_Reference translation by Taufiq Rafat, "Bulleh Shah: A Selection" (Vanguard, 1982), p.153. COPYRIGHTED — private reference only; do NOT publish or use for training._

# AI Translation

The mullah and the torch-bearer are of one mind:
they make light for others, while they themselves stay in the dark.
...
- URL or bibliographic reference: Vanguard Books, Lahore, 1982 — Rafat poem 46 "The Benighted", English book p.153 / Urdu original p.152
...
- Uncertainties: "donhāṁ iko chit" (دونہاں اِکو چِت, both of one mind/heart) — high confidence. Overall confidence: high; this is a short, clearly-written couplet.
