...
id: bulleh_shah_0058
poet_id: bulleh_shah
title: "Ho nahiṉ sabhe galṛiyāṉ (Obfuscation)"
work_type: "kafi"
source_ids:
...
ہو نہیں سبھے گلڑیاں، اللہ اللہ دی گل
کجھ رولا پایا عالماں، کجھ کاغذاں پایا جھل

# Script Notes

- Script: Shahmukhi (Perso-Arabic)
- Language spans: Punjabi
- Notes: Vision transcription of Rafat poem 57, read from the calligraphic Nastaliq facing page (book p.178). A short two-line couplet under a display-script title line. Needs native/scholarly verification.
...
_Reference translation by Taufiq Rafat, "Bulleh Shah: A Selection" (Vanguard, 1982), p.179. COPYRIGHTED — private reference only; do NOT publish or use for training._

# AI Translation

All else is idle prattle — the [only true] talk is "Allah, Allah."
Some of the confusion the scholars have raised, some clamour the paper-and-books have stirred.
...
- URL or bibliographic reference: Vanguard Books, Lahore, 1982 — Rafat poem 57 "Obfuscation", English book p.179 / Urdu original p.178
...
- Uncertainties: low. The word read as "jhal" (جھل, madness/frenzy) at the end of line 2 is confidently legible but the sense ("paper/books have stirred a frenzy") should be confirmed against a Kulliyat.
