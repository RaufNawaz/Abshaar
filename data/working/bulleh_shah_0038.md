...
id: bulleh_shah_0038
poet_id: bulleh_shah
title: "Gal samajh lai te raula keh (Names)"
work_type: "kafi"
source_ids:
...
گل سمجھ لئی تے رَولا کیہ

گل سمجھ لئی تے رَولا کیہ
ایہ رام، رحیم تے مَولا کیہ؟

# Script Notes

- Script: Shahmukhi (Perso-Arabic)
- Language spans: Punjabi (with Hindu/Muslim divine names — Ram, Rahim, Maula)
- Notes: Vision transcription of Rafat poem 37, read from the calligraphic Nastaliq facing page (book p.126). Only a single couplet appears on the page (Rafat titles it "Names"). Transcription high-confidence; verify against a print Kulliyat.
...
_Reference translation by Taufiq Rafat, "Bulleh Shah: A Selection" (Vanguard, 1982), p.127. COPYRIGHTED — private reference only; do NOT publish or use for training._

# AI Translation

Once the matter is truly understood, what is all this clamour about?
What, then, is this "Ram," this "Rahim," this "Maula"?
...
- URL or bibliographic reference: Vanguard Books, Lahore, 1982 — Rafat poem 37 "Names", English book p.127 / Urdu original p.126
...
- Questions: Verify the couplet against a print Kulliyat; confirm whether standalone or excerpted.
- Uncertainties: Low — گل سمجھ لئی تے رَولا کیہ / ایہ رام، رحیم تے مَولا کیہ reads clearly.
