...
id: bulleh_shah_0031
poet_id: bulleh_shah
title: "Roze hajj namaz ni maae (Rituals)"
work_type: "kafi"
source_ids:
...
روزے، حج، نماز نی مائے
مینوں پیا نے آن بھُلائے
جان پیا دیاں خبراں پئیاں
منطق، نحو سبھے بھُل گئیاں
اُس اَحد دے تار بجائے
روزے، حج، نماز نی مائے
مینوں پیا نے آن بھُلائے

جاں پیا میرے گھر آیا
بھُلّی مینوں شرح وقایہ
ہر مظہر وچ اوہا دِسدا
اندر باہر جلوہ اِس دا
بھُلّے لوکاں خبر نہ کائے
روزے، حج، نماز نی مائے
مینوں پیا نے آن بھُلائے
...
- Language spans: Punjabi (with madrasa terms: mantiq, nahv, Sharh al-Wiqaya)
- Notes: Vision transcription of Rafat poem 30, read from the calligraphic Nastaliq facing page (book p.104). Refrain "Roze, hajj, namaz ni maae / mainu piya ne aan bhulaae". Names the scholastic arts (mantiq = logic, nahv = grammar) and a specific Hanafi fiqh manual (Sharh al-Wiqaya) as what love makes the poet forget. Reasonably confident; verify against a print Kulliyat.
...
to prayer, love has drowned them all.
    Can any artifice survive
    when messages of love arrive?
    On the ears only its sounds fall.
        Fasting, pilgrimage, and the call
        to prayer, love has drowned them all.

The moment Love came toward
me, rituals went by the board.
Love, only love, was then to be seen,
over and under, around, between.
The loveless noticed nothing at all.
    Fasting, pilgrimage, and the call
    to prayer, love has drowned them all.

_Reference translation by Taufiq Rafat, "Bulleh Shah: A Selection" (Vanguard, 1982), p.105. COPYRIGHTED — private reference only; do NOT publish or use for training. Rafat generalises "mantiq/nahv" to "artifice" and "Sharh al-Wiqaya" to "rituals"._
...
in every manifestation He alone appears,
...
- URL or bibliographic reference: Vanguard Books, Lahore, 1982 — Rafat poem 30 "Rituals", English book p.105 / Urdu original p.104
...
- Questions: Verify the Nastaliq transcription against a print Kulliyat; confirm "Sharh Vaqaaya" = the fiqh text Sharh al-Wiqaya.
- Uncertainties: stanza 1 line 1 جان پیا دیاں خبراں پئیاں; stanza 1 line 3 اُس اَحد دے تار بجائے (Ahad/strings reading); stanza 2 line 2 شرح وقایہ. Otherwise the mapping to Rafat is clear. Flagged for rauf.
