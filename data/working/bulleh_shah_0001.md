...
رانجھا میں وچ میں رانجے وچ ہور خیال نا کوئی
میں نہیں اہ آپ ہے آپنی آپ کرے دلجوئی
رانجھا رانجھا کر دی نی میں آپے رانجھا ہوئی
ہتھ کھنڈی میرے اگے منگو موڈھے بھورا لوئی
بلہاؔ ہیر سلوٹی ویکھو کتھے جا کھلوئی
رانجھا رانجھا کر دی نی میں آپے رانجھا ہوئی
سدو نی مینوں دھیدو رانجھا ہیر نا آکھو کوئی
...
- Notes: Classical Punjabi kafi built on the Heer–Ranjha romance as a vehicle for fana (annihilation of the self in the beloved). The transliteration below is Abshaar's own reading (project-latin-v1); it is NOT copied from Sufinama or any other site. Original verses are public domain (poet d. 1757); the specific spelling shown follows the Sufinama page and should be cross-checked against a print edition.
...
- Source ID: source_sufinama_bulleh_0001
- Source title: Sufinama — Bulleh Shah kaafi (kaafi-12), "Ranjha Ranjha kardi"
- URL or bibliographic reference: https://sufinama.org/kaafi/bulleh-shah-kaafi-12
- Rights status: Composition is public domain (poet d. 1757). The Sufinama page (its digital transcription, Roman transliteration, Hindi rendering, and any meanings) is copyrighted and used here only for discovery and cross-reference, with attribution.
- Can this be published? no
- Can this be used for model training? no

# Review Notes

- Questions: Confirm the Shahmukhi text against a public-domain print edition (e.g. a Kulliyat-e-Bulleh Shah). Editions vary in spelling and line order.
- Uncertainties: Transliteration readings to verify — "mangu" (منگو), "saloti" (سلوٹی, Heer's epithet), "khundi" (کھنڈی, the jogi's staff/crook). Shahmukhi omits short vowels, so vowel choices are my best reading and need a native/scholarly check.
- Alternate readings: Line 4 "main nahin, oh aap hai" — verify against other transcriptions.
- Reviewer: (pending — rauf)
- Date: 2026-07-04 (original text + transliteration drafted by assistant; interpretive layers pending)
